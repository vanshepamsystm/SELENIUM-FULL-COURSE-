...
mail =driver.find_element(By.XPATH,"//a[text()='mentor@rahulshettyacademy.com']").text
driver.switch_to.window(windows[0])
driver.find_element(By.CSS_SELECTOR,"#username").send_keys(mail)
key = driver.find_element(By.XPATH,"//i[contains(text(),'Learning@830$3mK2')]").text
driver.find_element(By.NAME,"password").send_keys(key)
